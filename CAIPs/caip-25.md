...
For the response, we match the same scopes as the request but segregate (with extensions) 2 out of 5 EVM chains into their scopes because of either exclusive accounts or capabilities.
